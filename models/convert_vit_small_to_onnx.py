...
import numpy.core.multiarray  # Add this import for the scalar function
...
def main():
    # Define ViT_Small configuration
    config = Config(
        img_size=224,
        patch_size=16,
        num_classes=2,
    ...
    checkpoint_path = "F:\\Deepfake-Audio-Detector\\models\\.pth\\best_model_ViT_Small_vit_3s_dataset_040441.pth"  # Update this path if necessary
    if not os.path.exists(checkpoint_path):
        raise FileNotFoundError(f"Checkpoint file not found: {checkpoint_path}")

    # Allowlist the NumPy scalar function
